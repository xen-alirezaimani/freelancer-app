  ...
  return (
    open && (
      <div className="w-full h-screen z-100 inset-0 backdrop-blur-sm fixed top-0 left-0 bg-secondary-800/20">
        ...
        <div
          ref={ref}
          className="w-[calc(100vw-3rem)] md:max-w-lg max-h-[calc(100vh-3rem)] overflow-y-auto fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 rounded-lg bg-secondary-0 p-4 shadow-lg transition-all duration-500 ease-out"
        >
